...
import { UseAutocompleteProps } from '@nextui-org/autocomplete/dist/use-autocomplete.js';
...
type AutocompleteProps<T = object> = Props<T> & {
    ref?: Ref<HTMLElement>;
};
declare const _default: <T = object>(props: AutocompleteProps<T>) => ReactElement;
