...
import { TimeClockSlots, TimeClockSlotProps } from '@mui/x-date-pickers/TimeClock/TimeClock.types';
...
import { TimePickerToolbarProps, ExportedTimePickerToolbarProps } from '@mui/x-date-pickers/TimePicker/TimePickerToolbar';
